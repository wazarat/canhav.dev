...
export function BuiltForBuilders() {
  return (
    <section className="relative overflow-hidden rounded-3xl bg-[#3c72ab]">
      ...
      <div className="relative grid items-center gap-6 p-6 md:grid-cols-[1.15fr_1fr] md:gap-10 md:p-12">
        ...
        <div className="order-1 space-y-5 text-center md:order-2 md:text-left">
          ...
          >
            From token design to AI workflows that run on verified data, we work
            with small businesses to scope, build, and ship real DeFi solutions.
            Bring us the problem and we will help you explore what is possible.
          </p>
          <div className="pt-1">
            <ContactCta label="Contact us" sourcePage="home-teams" size="lg" />
          </div>
        </div>
      </div>
    </section>
